      ...
      <div className="space-y-6">
        <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-sm space-y-2">
                    <p>
                      ...
                      presentaciones semanales y participa activamente en las
                      sesiones de revisión.
                    </p>
                    <p>
                      <strong>Investigador Contribuidor:</strong> Aporta
                      documentación a la plataforma sin compromiso de
                      presentaciones.
                    </p>
                  </div>
                </div>
          ...
          <RadioGroup
            ...
            onValueChange={(value: "primary" | "contributor") =>
